...
setup(
  name = 'invoicing-pfd-practice',         #* Your package will have this name
  packages = ['mypackage'],   #* Name the package again
  ...
  description = 'Only for practice to create own package :)..!',    # Short description of your library
  author = 'Vengadesan G',                   # Your name
  author_email = 'your.email@example.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['invoice', 'excel', 'pdf', 'practice'],   # Keywords users can search on pypi.org
